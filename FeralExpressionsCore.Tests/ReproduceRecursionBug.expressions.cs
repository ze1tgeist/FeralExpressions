...
namespace FeralExpressionsCore.ReproduceRecursionBug
{
    ...
    {
        public static Expression<Func<IndependentSolutionDomainToDtoMapper<TDomainEntity,TDto>,TDomainEntity,TDto>> DomainEntityToDto_TDomainEntity_Expression =>
    ...
    {
        public static Expression<Func<LegislationModelToDtoConverter,Models.Legislation,Dtos.Legislation>> Convert_Legislation_Expression =>
